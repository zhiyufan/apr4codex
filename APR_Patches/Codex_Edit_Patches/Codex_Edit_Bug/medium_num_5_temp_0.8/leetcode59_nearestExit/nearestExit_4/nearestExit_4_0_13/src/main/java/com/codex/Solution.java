...
public class Solution {
    public static int nearestExit(char[][] maze, int[] entrance) {
        ...
        private class Element {
            ...
            int j;
            int count;
            public Element(int i, int j, int count) {
                this.i = i;
                this.j = j;
                this.count = count;
            }
    ...
    public static int nearestExit(char[][] maze, int[] entrance) {
        ...
        queue.offer(new Element(entrance[0], entrance[1], 0));
        while (!queue.isEmpty()) {
            ...
            for (int[] dir : dirs) {
                ...
                if (dist[x][y] + acc < dist[xx - dir[0]][yy - dir[1]]) {
                    dist[xx - dir[0]][yy - dir[1]] = dist[x][y] + acc;
                    queue.offer(new Element(xx - dir[0], yy - dir[1], acc));
                }
            }
        }
        int minDist = Integer.MAX_VALUE;
