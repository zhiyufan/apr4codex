...
public class Solution {
    public static int nearestExit(char[][] maze, int[] entrance) {
        ...
        // dist[i][j] means the minimum distance from entrance to (i, j).
        // By default, the minimum distance is Integer.MAX_VALUE.
        int m = maze.length;
        int n = maze[0].length;
        ...
        // Set the value of the minimum distance at the entrance to 0
