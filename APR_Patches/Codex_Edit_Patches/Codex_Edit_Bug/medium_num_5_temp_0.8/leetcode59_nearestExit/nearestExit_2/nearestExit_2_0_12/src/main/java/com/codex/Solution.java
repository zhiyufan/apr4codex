    ...
    public static int nearestExit(char[][] maze, int[] entrance) {
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                int curDist = curDist[cur[0]][cur[1]];
                int nextX1 = nextX - dx[i];
                int nextY1 = nextY - dy[i];
                // System.out.println(cur[0] + " " + cur[1] + " " + curDist);
                // System.out.println(curDist + step);
                if (!isValid(maze, nextX1, nextY1) && step != 0) {
                    continue;
                }
                ...
                // System.out.println(nextX1 + " " + nextY1 + " " + dist[nextX1][nextY1]);
            }
        }
