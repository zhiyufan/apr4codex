...
/**
 * Given a maze consisting of black walls and white walls, return the nearest exit point
 *
 * Should be an O(n * m) solution
 */
    public static int nearestExit(char[][] maze, int[] entrance) {
        ...
        // Output the shortest distance of the exit
