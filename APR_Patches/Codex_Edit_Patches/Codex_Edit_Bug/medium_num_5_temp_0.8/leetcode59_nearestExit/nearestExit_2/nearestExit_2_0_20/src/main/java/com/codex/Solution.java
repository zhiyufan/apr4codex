...
public class Solution {
    ...
    //This is the same problem as above, but instead of finding the shortest path, we should use the most steps of rolling.
    public static int shortestRollPath(char[][] maze, int[] entrance, int[] exit) {
        int[][] dist = new int[maze.length][maze[0].length];
        for (int i = 0; i < dist.length; i++) {
            for (int j = 0; j < dist[0].length; j++) {
