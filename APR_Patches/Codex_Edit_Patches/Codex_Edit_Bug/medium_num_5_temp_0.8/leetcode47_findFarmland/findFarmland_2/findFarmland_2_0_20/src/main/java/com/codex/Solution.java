...
public class Solution {
        ...
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                if (!isVisited[i][j] && land[i][j] == 1) {
                    ...
                    result[iResult][2] = i;
                    result[iResult][3] = j;
                    dfsFindFarmland(land, i, j, iResult, result, isVisited);
                    iResult++;
                }
            }
        }
    ...
    private static void dfsFindFarmland(int[][] land, int i, int j, int iResult, int[][] result, boolean[][] isVisited) {
        land[i][j] = 0;
        isVisited[i][j] = true;
        if (i > 0 && land[i - 1][j] == 1) {
            result[iResult][0] = Math.min(result[iResult][0], i - 1);
            dfsFindFarmland(land, i - 1, j, iResult, result, isVisited);
        }
        ...
        if (j > 0 && land[i][j - 1] == 1) {
            ...
            dfsFindFarmland(land, i, j - 1, iResult, result, isVisited);
        }
        ...
        if (i > 0 && j > 0 && land[i - 1][j - 1] == 1) {
            result[iResult][0] = Math.min(result[iResult][0], i - 1);
            result[iResult][1] = Math.min(result[iResult][1], j - 1);
            dfsFindFarmland(land, i - 1, j - 1, iResult, result, isVisited);
        }
