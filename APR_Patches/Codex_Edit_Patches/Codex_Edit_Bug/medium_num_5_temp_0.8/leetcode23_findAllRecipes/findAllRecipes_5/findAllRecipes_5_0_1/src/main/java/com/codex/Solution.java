...
public class Solution {
    ...
    public void main(String[] args){
        System.out.print(findAllRecipes(new String[]{"apple"},new String[]{"bread","butter","eggs","flour","margarine","sugar","water"}));
    }

    public static String[] findAllRecipes(String[] recipes, String[] supplies) {
