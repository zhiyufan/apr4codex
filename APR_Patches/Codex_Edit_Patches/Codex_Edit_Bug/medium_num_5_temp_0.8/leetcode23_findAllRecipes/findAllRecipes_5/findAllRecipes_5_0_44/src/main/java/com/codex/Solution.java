...
public class Main {
    ...
    public static void main(String[] args) {
        String[] recipes = {"tacos", "cereal", "sandwich", "soup"};
        List<List<String>> ingredients = new ArrayList<>();
        ingredients.add(List.of("tortilla", "ground beef", "cheese"));
        ingredients.add(List.of("milk", "cheerios"));
        ingredients.add(List.of("bread", "turkey", "cheese"));
        ingredients.add(List.of("chicken", "noodles"));
        String[] supplies = {"turkey", "cheerios", "ground beef", "cheese"};
