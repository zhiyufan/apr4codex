...
public static List<String> findAllRecipes(String[] recipes, List<List<String>> ingredients, String[] supplies) {
	...
	String[] recipes = {"Pizza", "Pie", "Cereal"};

	List<List<String>> ingredients = new ArrayList<>();
	ingredients.add(Arrays.asList("Cheese", " dough", " tomatoes"));
	ingredients.add(Arrays.asList("flour", " butter", "sugar"));
	ingredients.add(Arrays.asList("milk", " cereal"));
	
	String[] supplies = {"dough", "butter", "sugar", "milk", "cheese"};
	System.out.println("Can make " + findAllRecipes(recipes, ingredients, supplies));


	assertEquals(Arrays.asList("Pizza", "Pie"), findAllRecipes(recipes, ingredients, supplies));
}