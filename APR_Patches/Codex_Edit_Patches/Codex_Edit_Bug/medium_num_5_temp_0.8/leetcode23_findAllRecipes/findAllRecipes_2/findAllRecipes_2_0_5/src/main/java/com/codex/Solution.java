...
public static List<String> findAllRecipes(String[] recipes, List<List<String>> ingredients, String[] supplies) {
    ...
    private static boolean canMakeRecipe(Map<String, String> graph, Map<String, String> supply, String recipe, Set<String> visited) {
        ...
        visited.add(recipe);
        return canMakeRecipe(graph, supply, graph.get(recipe), visited);
    }
}