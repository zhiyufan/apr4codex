...
// 2d matrix, find the maximum sum of the path from top left to the bottom right
// only down and right allowed

// If a given element is negative, then it should not be part of the sum.
