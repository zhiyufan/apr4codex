...
import java.util.ArrayList;
    ...
    public static int[] rearrangeArray2(int[] nums) {
        ...
        ArrayList<Integer> equelToAverage = new ArrayList<>();
        ...
        for (int i = 0; i < nums.length; i++) {
            if (i == 0) {
                ...
                } else if (equelToAverage.size() > 0) {
                    newArray[i] = equelToAverage.get(0);
                    equelToAverage.remove(0);
        } 
    ...
    static int[] sort(int[] nums) {
        ...
        for (int i = 0; i < nums.length; i++) {
            if (positives.size() > 0 && negativeIndex == 0) {
                ...
                negatives.remove(0);
            } else if (zero.size() > 0 && negativeIndex == 0) {
                newArray[i] = zero.get(0);
                zero.remove(0);
                positiveIndex = 1;
