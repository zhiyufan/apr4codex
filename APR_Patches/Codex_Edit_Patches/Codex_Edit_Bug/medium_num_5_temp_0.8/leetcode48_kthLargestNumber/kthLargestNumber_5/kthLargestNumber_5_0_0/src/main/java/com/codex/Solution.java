...
public class Solution {
    public static String kthLargestNumber(String[] nums, int k) {  
        ...
        if (k <= 0) {
            throw new IllegalArgumentException("k should be in range!");
        }
        // the comparator should be the same as the comparator used in the
        // PriorityQueue. So if we use a small root heap, then we need to
        // implement a small root heap comparator.
