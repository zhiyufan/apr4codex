            ...
            if (directions.charAt(i) == 'S') {
                ...
                for (int j = 0; j < directions.length(); j++) {              
                    if ((directions.charAt(i) != directions.charAt(j) && directions.charAt(j) != 'S')) {
                        collisions += 2;
                        System.out.println(directions.charAt(i) + " " + directions.charAt(j));
                        ...
                        i--;  // This line is important. In some cases, you have to check the same index again.
                        break;
                    }
                }
            }
