...
public static int getLucky(String s, int k) {
        ...
        } else if (s.contains("b") && k == 0) {
            convert = s.indexOf('b') + 2;
        } else if (s.contains("c") && k == 0) {
            convert = s.indexOf('c') + 3;
        } else if (s.contains("d") && k == 0) {
            convert = s.indexOf('d') + 4;
        } else if (s.contains("e") && k == 0) {
            convert = s.indexOf('e') + 5;
        } else if (s.contains("f") && k == 0) {
            convert = s.indexOf('f') + 6;
        } else if (s.contains("g") && k == 0) {
            convert = s.indexOf('g') + 7;
        } else if (s.contains("h") && k == 0) {
            convert = s.indexOf('h') + 8;
        } else if (s.contains("i") && k == 0) {
            convert = s.indexOf('i') + 9;
        } else if (s.contains("j") && k == 0) {
