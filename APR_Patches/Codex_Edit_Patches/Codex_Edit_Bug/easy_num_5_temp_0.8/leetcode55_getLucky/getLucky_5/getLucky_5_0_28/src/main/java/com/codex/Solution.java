...
public static int getLucky(String s, int k) {
        ...
        if (s.contains("a")) {
            initial = s.indexOf('a') + 1;
        } else if (s.contains("b")) {
            initial = s.indexOf('b') + 2;
        } else if (s.contains("c")) {
            initial = s.indexOf('c') + 3;
        } else if (s.contains("d")) {
            initial = s.indexOf('d') + 4;
        } else if (s.contains("e")) {
            initial = s.indexOf('e') + 5;
        } else if (s.contains("f")) {
            initial = s.indexOf('f') + 6;
        } else if (s.contains("g")) {
            initial = s.indexOf('g') + 7;
        } else if (s.contains("h")) {
            initial = s.indexOf('h') + 8;
