...
public static int minimumMoves1(String s) {
        ...
        int move = 0;
        while(s.length() > 1){
            if(s.charAt(0) == 'X' && s.charAt(1) == 'X' && (s.charAt(2) == 'X' || s.charAt(2) == 'O')){
                s = s.replaceFirst("XXX", "OOO");
                move++;
            }else if(s.charAt(0) == 'X' && s.charAt(1) == 'O' && (s.charAt(2) == 'X' || s.charAt(2) == 'O')){
                s = s.replaceFirst("XO", "XO");
                move++;
            }else if(s.charAt(0) == 'O' && s.charAt(1) == 'X' && (s.charAt(2) == 'X' || s.charAt(2) == 'O')){
                s = s.replaceFirst("OX", "OX");
                move++;
            }else if(s.charAt(0) == 'O' && s.charAt(1) == 'O' && (s.charAt(2) == 'X' || s.charAt(2) == 'O')){
