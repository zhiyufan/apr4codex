...
public class Solution {
    public static int nearestExit(char[][] maze, int[] entrance) {
        ...
        int res = Integer.MAX_VALUE; // <-- Here, when you should step from the start point to the end point, the maximum possible steps is "maze.length * maze[0].length". Therefore, you should set the default res to be "maze.length * maze[0].length" instead of "Integer.MAX_VALUE"
