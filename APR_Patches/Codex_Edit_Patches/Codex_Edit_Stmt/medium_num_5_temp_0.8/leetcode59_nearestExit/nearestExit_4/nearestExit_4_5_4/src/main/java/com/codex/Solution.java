...
public class Solution {
    ...
    private int minDist = Integer.MAX_VALUE;
        ...
        private void dfs(int[][] maze, int[] start, int[] destination, boolean[][] visited, int dist) {
            ...
            for (int[] dir : dirs) {
                ...
                if (x - dir[0] == destination[0] && y - dir[1] == destination[1]) {
                    count++;
                }
                if (!visited[x - dir[0]][y - dir[1]]) {
                    dfs(maze, new int[]{x - dir[0], y - dir[1]}, destination, visited, dist + count);
                }
            }
            visited[r][c] = false;
        }
