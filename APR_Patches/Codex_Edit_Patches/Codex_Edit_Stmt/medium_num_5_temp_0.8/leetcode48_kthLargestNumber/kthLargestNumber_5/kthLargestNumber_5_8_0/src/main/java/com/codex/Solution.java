...
public class Solution {
    public static String kthLargestNumber(String[] nums, int k) {
        ...
        //nums中所有元素都是字符串，但是要排序的是数字，堆中存的是数字，所以用数字对比，自己写方法比较，比较规则使用两个数组起来的大小，不相等的时候返回比较的结果，相等的时候继续比较下一个数字
        for (String s : nums) {
    ...
    private static int getFirstComparison(int a, int b) {
        String strA = String.valueOf(a);    //把数字转换成字符串
        String strB = String.valueOf(b);    //把数字转换成字符串
