...
public class Solution {
    public static int digArtifacts(int n, int[][] artifacts, int[][] dig) {
        ...
        // 1. get the center point of all artifacts, ordered by the furthest distance from the (0, 0) point
        // 2. for each center point, scan through the rows and cols to see how many non-zero points it hits
        // 3. if the center is not zero and the non-zero points hits are larger than 2, abandon it, else count it and mark the center point as 0
