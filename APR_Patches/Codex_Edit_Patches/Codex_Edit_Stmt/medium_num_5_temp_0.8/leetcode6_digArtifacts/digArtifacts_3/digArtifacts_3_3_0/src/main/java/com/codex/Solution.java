...
public static int digArtifacts(int n, int[][] artifacts, int[][] dig) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            cols[i] = Math.min(artifacts[i][1], artifacts[i][3]);
        ...
        for (int i = 0; i < d; i++) {
            ...
            rows[art] = 0;
            cols[art] = 0;
            if (artifacts[art][1] < artifacts[art][3]) {// In case of gaint artifact when cols[art] < rows[art]
            ...
            if (artifacts[art][0] < artifacts[art][2]) {// In case of gaint artifact when cols[art] > rows[art]
