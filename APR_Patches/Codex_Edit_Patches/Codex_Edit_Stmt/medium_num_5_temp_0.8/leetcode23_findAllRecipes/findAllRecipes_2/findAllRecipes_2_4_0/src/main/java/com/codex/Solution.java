...
public class Solution {
   public static void main(String[] args) {
        String[] recipes = {"banana", "chocolate", "cake"};
        String[] supplies = {"banana", "chocolate", "chocolate"};
        List<List<String>> ingredients = new ArrayList<>();
        ingredients.add(Arrays.asList("banana"));
        ingredients.add(Arrays.asList("chocolate", "cake"));
        ingredients.add(Arrays.asList("chocolate", "banana"));
