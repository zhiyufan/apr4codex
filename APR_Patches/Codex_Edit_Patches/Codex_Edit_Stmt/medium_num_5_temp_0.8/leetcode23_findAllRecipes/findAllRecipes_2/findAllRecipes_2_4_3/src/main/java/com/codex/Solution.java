...
public class Solution {
    public static List<String> findAllRecipes(String[] recipes, List<List<String>> ingredients, List<String> supplies) {
    ...
    private static Map<String, String> getSupplies(List<String> supplies) {
