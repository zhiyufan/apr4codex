...
public class Solution {
    ...
    private static boolean isPuncuationMark(char ch) {
        ArrayList<Character> listOfPunctuationMarks;
        listOfPunctuationMarks = new ArrayList<>();
        
        listOfPunctuationMarks.add(Character.valueOf('!'));
        listOfPunctuationMarks.add(Character.valueOf(','));
        listOfPunctuationMarks.add(Character.valueOf('.'));
        
        return listOfPunctuationMarks.contains(Character.valueOf(ch));
    }
}