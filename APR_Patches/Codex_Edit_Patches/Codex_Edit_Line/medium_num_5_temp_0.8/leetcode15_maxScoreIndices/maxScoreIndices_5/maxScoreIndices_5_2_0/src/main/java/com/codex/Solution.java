...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] test2 = {1, 0, 1, 0, 0, 1, 0};
        int[] test3 = {1, 0, 1, 0, 0, 1, 1, 1};
        System.out.println(maxScoreIndices(test1));
        System.out.println(maxScoreIndices(test2));
        System.out.println(maxScoreIndices(test3));
    }
    }
